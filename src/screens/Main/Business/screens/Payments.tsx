...
export default function PaymentsScreen({ route, navigation }: any) {
	...
	const [accountType, setAccountType] = React.useState(
		businessData.bankAccountType ?? "unselected"
	);
	const [pixType, setPixType] = React.useState<PIX_TYPE>(
		(businessData.bankPixType as unknown as PIX_TYPE) ?? "unselected"
	);
							...
							<Controller
								...
								render={({
									...
									<Input
										...
										style={
											!!errors.pixKey && borderErrorStyle
										}
									/>
								)}
								name="pixKey"
