...
// Types
import { BusinessData, socialMediaScheme, SocialMediaSchemeType } from 'screens/Main/Business/@types';
...
export default function SocialMedia({ route, navigation }: any) {
    ...
    const { handleSubmit, control, formState: { errors }, getValues, watch, setFocus } = useForm<SocialMediaSchemeType>({
        mode: 'onSubmit',
        defaultValues: {
            site: "",
            facebook: "",
                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value } }) => (
                            <Input
                                ...
                                autoCapitalize='none'
                                onChangeText={onChange}
                                style={!!errors.whatsAppBusiness && borderErrorStyle}
                            />
                        )}
