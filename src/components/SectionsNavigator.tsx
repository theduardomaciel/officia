                ...
                sections.map((section, index) => {
                    ...
                    const textAnimationStyle = useAnimatedStyle(() => {
                        const color = interpolateColor(
                            ...
                            [colors.gray[100], colors.primary.green, colors.gray[100]]
                        );
                    ...
                    return (
                        ...
                        >
                            <Animated.Text style={textAnimationStyle} className={'font-bold text-xs text-black dark:text-gray-100'}>
                                {section.title}
                            </Animated.Text>
                            <View className={'bg-black overflow-hidden dark:bg-gray-100 h-[3px] rounded'} style={{
                                width: lineWidth,
                            }}>
                                <Animated.View
