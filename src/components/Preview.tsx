...
const Category = ({ category }: { category: CategoryModel }) => (
    <>
        <MaterialIcons
...
interface PreviewStatic {
    product?: PreviewProps["product"];
    material?: PreviewProps["material"];
    palette?: "light";
    hasBorder?: boolean;
    padding?: "small";
    onPress?: () => void;
        ...
        >
            <View className="flex-1 flex-col items-start justify-center gap-y-2 mr-3">
                ...
                <View className="flex-row">
                    ...
                    {material && (
                        <Text className="font-semibold text-black dark:text-white text-xs mr-1">
                            {`${
                                material?.responsibility === "PROJECT"
                                    ? "Fornecido como cortesia"
                                    : material.responsibility == "COSTUMER"
                                    ? "Custo do cliente"
                                    : "Custo da empresa"
                            }`}
                        </Text>
            ...
            <View
                className={clsx("px-3 py-1 rounded-full", {
                    ...
                    "bg-primary-red": material?.responsibility == "PROJECT",
                })}
            >
...
interface PreviewProps {
    material?: Partial<MaterialModel>;
